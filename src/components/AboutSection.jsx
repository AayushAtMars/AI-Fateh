...
const AboutSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative items-center px-4 py-12 mb-4 overflow-hidden sm:px-6 md:px-8 lg:px-12 sm:py-12 md:py-4 "
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mb-16 text-center">
          <p className="mb-5 text-sm font-medium tracking-wide text-gray-500 transition-all duration-300 cursor-default sm:text-base hover:text-orange-500 hover:scale-105">
            What is Super60
          </p>

          <h2 className="text-xl font-extrabold leading-tight text-center text-gray-900 mb-9 sm:text-xl md:text-2xl lg:text-4xl">
            The{" "}
            <span
            ...
            Community
            <br />
            <span className="block mt-2 text-base font-medium text-orange-500 sm:text-lg md:text-md lg:text-xl">
        ...
        <div className="mb-8">
          ...
          {/* Focus Cards Grid */}
          <div className="grid gap-4 px-5 sm:grid-cols-2 lg:grid-cols-4 lg:gap-10">
            {focusAreas.map((area, index) => (
              <div
                key={area.id}
                className={`relative group p-6 rounded-xl transition-all duration-500 cursor-pointer cursor-target 
                  ${hoveredCard === area.id
