...
const GridItem = ({
  ...
  return (
    <li
      className={`cursor-target min-h-[20rem] list-none ${area} flex flex-col transition-opacity duration-500 ease-in-out ${anyHovered && !isHovered ? "opacity-40" : "opacity-100"
        }`}
      onMouseEnter={handleMouseEnter}
      onMouseLeave={handleMouseLeave}
      style={{ transition: "opacity 0.5s" }}
